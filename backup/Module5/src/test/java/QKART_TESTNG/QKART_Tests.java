...
public class QKART_Tests {
    ...
    public void TestCase02(@Optional("testUser") String username, @Optional("abc@123") String password) throws InterruptedException {
        ...
        assertTrue(status,"Verify User Registration Failed !");
        ...
        assertFalse(status, "Verify User reRegistration Passed!");
    }
    ...
    public void TestCase03(@Optional("YONEX") String productName) throws InterruptedException {
        ...
        assertFalse(!status,"Test Case Failure. Unable to search for given product");
        ...
        assertFalse(searchResults.size()==0,"No results Found !");
        ...
        for (WebElement webElement : searchResults) {
            ...
            assertFalse(!elementText.toUpperCase().contains(productName),"TestResult contains un-expected values.");
        }
        ...
        //we are doing asserts only for the fails
    ...
    public void TestCase04(@Optional("Running Shoes") String productName) throws InterruptedException {
    ...
    public void TestCase05(@Optional("YONEX") String productOne,@Optional("Tan") String productTwo, @Optional("Addr line 1 addr Line 2 addr line 3") String address) throws InterruptedException {
        Boolean status;
        ...
        assertFalse(!status,"Test Case Failure. Happy Flow Test Failed !");
    ...
    public void TestCase06(@Optional("Xtend Smart Watch") String productOne, @Optional("Yarine Floor Lamp") String productTwo) throws InterruptedException {
        Boolean status;
        ...
        homePage.changeProductQuantityinCart(productOne, 2);

        // update table lamp quantity to 0
        homePage.changeProductQuantityinCart(productTwo, 0);

        // update watch quantity again to 1
        homePage.changeProductQuantityinCart(productOne, 1);
    ...
    public void TestCase07(@Optional("Stylecon 9 Seater RHS Sofa Set,Xtend Smart Watch") String products) throws InterruptedException {
        Boolean status = false;
    ...
    public void TestCase08(@Optional("Stylecon 9 Seater RHS Sofa Set") String productName, @Optional("10") int quantity) throws InterruptedException {
        Boolean status;
    ...
    public void TestCase11(@Optional("crio user") String contactName,@Optional("criouser@gmail.com") String emailId,@Optional("Testing the contact us page") String msg) throws InterruptedException {
    ...
    public void TestCase12(@Optional("YONEX Smash Badminton Racquet") String productToSearch,@Optional("Addr line 1  addr Line 2  addr line 3") String address) throws InterruptedException {
        Boolean status = false;
